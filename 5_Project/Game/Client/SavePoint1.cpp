...
void SavePoint1::Init()
{
	...
	MapLoader::LoadMap("MapData\\SavePoint1.json", cameraObj, "SavePoint1");
	...
	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("TutorialScene", { 0.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 43.5 * 128.f, 10 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("MainStage1", { 14.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 4 * 128.f });
