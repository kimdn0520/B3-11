...
void SavePoint2::Init()
{
	...
	stageBackground->GetComponent<Transform>()->SetLocalPosition(Vector2(896.f, 512.f));
	stageBackground->AddComponent<SpriteRenderer>();
	stageBackground->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Savepoint 14 x 8 (1792_1024).png", Vector2(0, 0), 1792.f, 1024.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground->GetComponent<SpriteRenderer>()->SetWH(1792.f, 1024.f);
	stageBackground->SetCameraView(true);

	GameObject* stageBackground2 = new GameObject(TAG::UI);
	stageBackground2->SetName("StageBackground");
	stageBackground2->AddComponent<Transform>();
	stageBackground2->GetComponent<Transform>()->SetLocalPosition(Vector2(1152.f, 512.f));
	stageBackground2->AddComponent<SpriteRenderer>();
	stageBackground2->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Savepoint 14 x 8 (1792_1024).png", Vector2(0, 0), 1792.f, 1024.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground2->GetComponent<SpriteRenderer>()->SetWH(1792.f, 1024.f);
	stageBackground2->SetCameraView(true);

	MapLoader::LoadMap("MapData\\SavePoint1.json", cameraObj, "SavePoint2");
	...
	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("MainStage1", { 0.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 62.5 * 128.f, 6 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("ChallengeStage", { 14.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 44 * 128.f });
