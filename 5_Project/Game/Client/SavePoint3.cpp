...
void SavePoint3::Init()
{
	...
	MapLoader::LoadMap("MapData\\SavePoint1.json", cameraObj, "SavePoint3");
	...
	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("ChallengeStage", { 0.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 48.5 * 128.f, 5 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("BossMap", { 14.5 * 128.f, 7 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 0.5 * 128.f });
