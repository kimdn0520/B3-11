...
{	
	...
	MapLoader::LoadMap("MapData\\TutorialStage.json", cameraObj);

	// Tutorial Text
	GameObject* tutorialText_1 = new GameObject(TAG::UI);
	tutorialText_1->SetName("DashImage");
	tutorialText_1->AddComponent<Transform>();
	tutorialText_1->GetComponent<Transform>()->SetLocalPosition(Vector2(1000.f, 450.f));
	tutorialText_1->AddComponent<SpriteRenderer>();
	tutorialText_1->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\MoveJumpText.png", Vector2(0, 0), 500, 200, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	tutorialText_1->GetComponent<SpriteRenderer>()->SetWH(500.f, 200.f);
	tutorialText_1->SetCameraView(true);

	GameObject* tutorialText_2 = new GameObject(TAG::UI);
	tutorialText_2->SetName("TutorialText_2");
	tutorialText_2->AddComponent<Transform>();
	tutorialText_2->GetComponent<Transform>()->SetLocalPosition(Vector2(1500.f, 450.f));
	tutorialText_2->AddComponent<SpriteRenderer>();
	tutorialText_2->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\DashAttackText.png", Vector2(0, 0), 500, 200, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	tutorialText_2->GetComponent<SpriteRenderer>()->SetWH(500.f, 200.f);
	tutorialText_2->SetCameraView(true);

	GameObject* tutorialText_3 = new GameObject(TAG::UI);
	tutorialText_3->SetName("TutorialText_3");
	tutorialText_3->AddComponent<Transform>();
	tutorialText_3->GetComponent<Transform>()->SetLocalPosition(Vector2(2500.f, 450.f));
	tutorialText_3->AddComponent<SpriteRenderer>();
	tutorialText_3->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\ChargeAttackText.png", Vector2(0, 0), 500, 200, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	tutorialText_3->GetComponent<SpriteRenderer>()->SetWH(1000.f, 400.f);
	tutorialText_3->SetCameraView(true);

	GameObject* tutorialText_4 = new GameObject(TAG::UI);
	tutorialText_4->SetName("TutorialText_4");
	tutorialText_4->AddComponent<Transform>();
	tutorialText_4->GetComponent<Transform>()->SetLocalPosition(Vector2(4400.f, 2000.f));
	tutorialText_4->AddComponent<SpriteRenderer>();
	tutorialText_4->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\WallJumpText.png", Vector2(0, 0), 500, 200, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	tutorialText_4->GetComponent<SpriteRenderer>()->SetWH(800.f, 400.f);
	tutorialText_4->SetCameraView(true);
	...
	//GetThroughTilePrefab* passTileObj = new GetThroughTilePrefab("passTile", 600,600,128.f,40.f);

	// 총알이 닿으면 사라지는 벽
	//BrokenWallPrefab* brokenWallObj = new BrokenWallPrefab("BrokenWall", 300.f, 2000.f, 30, 200);
	
	// 적
	EnemyPrefab* enemyTurtle = new EnemyPrefab("Turtle", { 20 * 128.f, 5 * 128.f }, 240, 150);
	enemyTurtle->AddComponent<Turtle>();

	EnemyPrefab* enemyObj2 = new EnemyPrefab("JellyFish", { 35 * 128.f, 15 * 128.f }, 120, 150);
	enemyObj2->AddComponent<JellyFish>();
	

	// 다음맵 포탈
	PortalPrefab* portalObj = new PortalPrefab("SavePoint1", {44.5 * 128.f, 10.5 * 128.f}, 100.f, 400.f, { 1.5 * 128.f, 7 * 128.f });
	//PortalPrefab* portalObj = new PortalPrefab("MainStage1", { 1000.f, 500.f }, 100.f, 300.f);
...
#pragma region MakePool
	//{
	//	for (int i = 0; i < 20; i++)
	//	{
	//		GET_SINGLE(ObjectPool)->CreateNewObj(new BulletPrefab());
	//	}

	//	/*for (int i = 0; i < 5; i++)
	//	{
	//		GET_SINGLE(ObjectPool)->CreateNewObj(new TestEnemyPrefab());
	//	}*/
	//}
#pragma region
