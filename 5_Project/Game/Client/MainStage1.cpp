...
void MainStage1::Init()
{
	...
	stageBackground->GetComponent<Transform>()->SetLocalPosition(Vector2(4800.f, 2240.f));
	stageBackground->AddComponent<SpriteRenderer>();
	stageBackground->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Tower 75 x 35 (9600_4480).png", Vector2(0, 0), 9600.f, 4480.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground->GetComponent<SpriteRenderer>()->SetWH(9600.f, 4480.f);
	stageBackground->SetCameraView(true);

	MapLoader::LoadMap("MapData\\MainStage1.json", cameraObj);

	// Dash Item
	//ItemPrefab* itemObj1 = new ItemPrefab("Dash", { 1000.f,700.f }, 10, true);

	// Charge Item
	//ItemPrefab* itemObj2 = new ItemPrefab("Charge", { 1300.f,700.f }, 8, true);
	...
	EnemyPrefab* enemyObj = new EnemyPrefab("Shark", { 40 * 128.f , 30 * 128.f }, 240, 150);
	enemyObj->AddComponent<Shark>();
	enemyObj->GetScriptComponent<Shark>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	EnemyPrefab* enemyObj2 = new EnemyPrefab("Penguin", { 20 * 128.f, 30 * 128.f }, 150, 150);
	enemyObj2->AddComponent<Penguin>();
	enemyObj2->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("SavePoint1", { 0.5 * 128.f, 5 * 128.f }, 100.f, 400.f, { 13.5 * 128.f, 6 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("TransitionVerti", { 0.5 * 128.f, 33 * 128.f }, 100.f, 400.f, { 13.5 * 128.f, 5 * 128.f });
	PortalPrefab* portalObj3 = new PortalPrefab("MiddleSave", { 30 * 128.f, 35.5 * 128.f }, 400.f, 100.f, { 10.5 * 128.f, 0.5 * 128.f });
	PortalPrefab* portalObj4 = new PortalPrefab("TransitionDash", { 64.5 * 128.f, 33 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 4.5 * 128.f });
	PortalPrefab* portalObj5 = new PortalPrefab("SavePoint2", { 64.5 * 128.f, 5.5 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 5 * 128.f });
