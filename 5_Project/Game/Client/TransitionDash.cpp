...
void TransitionDash::Init()
{
	...
	stageBackground->GetComponent<Transform>()->SetLocalPosition(Vector2(960.f, 2240.f));
	stageBackground->AddComponent<SpriteRenderer>();
	stageBackground->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Vertical 15 x 35 (1920_4480).png", Vector2(0, 0), 1920.f, 4480.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground->GetComponent<SpriteRenderer>()->SetWH(1920.f, 4480.f);
	stageBackground->SetCameraView(true);

	MapLoader::LoadMap("MapData\\TransitionDash.json", cameraObj);
	...
	// 적
	EnemyPrefab* enemyObj1 = new EnemyPrefab("Turtle", { 7 * 128.f, 6 * 128.f }, 240, 150);
	enemyObj1->AddComponent<Turtle>();
	
	EnemyPrefab* enemyObj2 = new EnemyPrefab("Turtle", { 7 * 128.f, 13 * 128.f }, 240, 150);
	enemyObj2->AddComponent<Turtle>();

	EnemyPrefab* enemyObj3 = new EnemyPrefab("JellyFish", { 7 * 128.f, 22 * 128.f }, 120, 150);
	enemyObj3->AddComponent<JellyFish>();

	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("MainStage1", { 0.5 * 128.f, 5 * 128.f }, 100.f, 400.f, { 62.5 * 128.f, 33 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("MiddleSave", { 0.5 * 128.f, 27.5 * 128.f }, 100.f, 400.f, { 18.5 * 128.f, 17 * 128.f });
	PortalPrefab* portalObj3 = new PortalPrefab("DashMap", { 14.5 * 128.f, 5 * 128.f }, 100.f, 400.f, { 57.5 * 128.f, 4 * 128.f });
	PortalPrefab* portalObj4 = new PortalPrefab("DashMap", { 14.5 * 128.f, 27.5 * 128.f }, 100.f, 400.f, { 57.5 * 128.f, 27 * 128.f });
