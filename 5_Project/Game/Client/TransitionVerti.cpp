...
void TransitionVerti::Init()
{
	...
	MapLoader::LoadMap("MapData\\TransitionVerti.json", cameraObj);
	...
	// 적
	EnemyPrefab* enemyObj = new EnemyPrefab("Turtle", { 7 * 128.f, 5 * 128.f }, 240, 150);
	enemyObj->AddComponent<Turtle>();
	
	EnemyPrefab* enemyObj2 = new EnemyPrefab("JellyFish", { 7 * 128.f, 20 * 128.f }, 120, 150);
	enemyObj2->AddComponent<JellyFish>();

	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("MainStage1", { 14.5 * 128.f, 5 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 33 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("MiddleSave", { 14.5 * 128.f, 28 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 17 * 128.f });
	PortalPrefab* portalObj3 = new PortalPrefab("AcquireCharge", { 0.5 * 128.f, 5 * 128.f }, 100.f, 400.f, { 2.5 * 128.f, 6 * 128.f });
	PortalPrefab* portalObj4 = new PortalPrefab("AcquireCharge", { 0.5 * 128.f, 28 * 128.f }, 100.f, 400.f, { 2.5 * 128.f, 13 * 128.f });
