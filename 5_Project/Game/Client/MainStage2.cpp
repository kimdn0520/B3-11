...
void MainStage2::Init()
{
	...
	// Player
	B3_11Prefab* playerObj = new B3_11Prefab({ 128.f, 500.f });
	...
	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("TransitionVerti", { 128.f, 7 * 128.f }, 100.f, 400.f, { 128.f, 7 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("TransitionVerti", { 128.f, 15 * 128.f }, 100.f, 400.f, { 128.f, 7 * 128.f });
