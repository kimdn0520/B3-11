...
void MiddleSave::Init()
{
	...
	MapLoader::LoadMap("MapData\\MiddleSave.json", cameraObj);
	...
	// 다음맵 포탈
	//PortalPrefab* portalObj1 = new PortalPrefab("MainStage1", { 9.5 * 128.f, 128.f }, 400.f, 100.f, { 9.5 * 128.f, 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("TransitionVerti", { 0.5 * 128.f, 17.5 * 128.f }, 100.f, 400.f, { 9.5 * 128.f, 26.5 * 128.f });
	PortalPrefab* portalObj3 = new PortalPrefab("TransitionDash", { 19.5 * 128.f, 17.5 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 26.5 * 128.f });
