...
void DashMap::Init()
{
	...
	stageBackground->GetComponent<Transform>()->SetLocalPosition(Vector2(4160.f, 2240.f));
	stageBackground->AddComponent<SpriteRenderer>();
	stageBackground->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Dash Map 65 x 35 (8320_4480).png", Vector2(0, 0), 8320.f, 4480.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground->GetComponent<SpriteRenderer>()->SetWH(8320.f, 4480.f);
	stageBackground->SetCameraView(true);

	MapLoader::LoadMap("MapData\\DashMap.json", cameraObj);
	...
	// Dash Item
	ItemPrefab* itemObj = new ItemPrefab("Dash", { 44.5 * 128.f, 21.5 * 128.f }, 50, true);
	...
	EnemyPrefab* enemyObj1 = new EnemyPrefab("Penguin", { 36 * 128.f, 4 * 128.f }, 150, 150);
	enemyObj1->AddComponent<Penguin>();
	enemyObj1->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());
	EnemyPrefab* enemyObj2 = new EnemyPrefab("Penguin", { 16 * 128.f, 11 * 128.f }, 150, 150);
	enemyObj2->AddComponent<Penguin>();
	enemyObj2->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());
	EnemyPrefab* enemyObj3 = new EnemyPrefab("Penguin", { 48 * 128.f, 11 * 128.f }, 150, 150);
	enemyObj3->AddComponent<Penguin>();
	enemyObj3->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());
	EnemyPrefab* enemyObj4 = new EnemyPrefab("Penguin", { 32 * 128.f, 15 * 128.f }, 150, 150);
	enemyObj4->AddComponent<Penguin>();
	enemyObj4->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("TransitionDash", { 59.5 * 128.f, 3.5 * 128.f }, 100.f, 400.f, { 13.5 * 128.f, 4.5 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("TransitionDash", { 59.5 * 128.f, 27 * 128.f }, 100.f, 400.f, { 13.5 * 128.f, 26.5 * 128.f });
