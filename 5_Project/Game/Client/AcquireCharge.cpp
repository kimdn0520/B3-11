...
void AcquireCharge::Init()
{
	...
	stageBackground->GetComponent<Transform>()->SetLocalPosition(Vector2(5120.f, 2240.f));
	stageBackground->AddComponent<SpriteRenderer>();
	stageBackground->GetComponent<SpriteRenderer>()->SetSprite(GEngine->LoadSpriteFromSheet(L"..\\..\\4_Resources\\ProjectSheet\\BackgroundSheet\\Wall_Charge Map 80 x 35 (10240_4480).png", Vector2(0, 0), 10240, 4480.f, Vector2(0.5f, 0.5f), 0.f, 1.0f));
	stageBackground->GetComponent<SpriteRenderer>()->SetWH(10240.f, 4480.f);
	stageBackground->SetCameraView(true);

	MapLoader::LoadMap("MapData\\AcquireCharge.json", cameraObj);
	...
	// Charge Item
	ItemPrefab* itemObj = new ItemPrefab("Charge", { 41.5 * 128.f, 31.5 * 128.f }, 50, true);
	...
	EnemyPrefab* enemyObj1 = new EnemyPrefab("Shark", { 50 * 128.f, 15 * 128.f }, 240, 150);
	enemyObj1->AddComponent<Shark>();
	enemyObj1->GetScriptComponent<Shark>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	EnemyPrefab* enemyObj2 = new EnemyPrefab("Shark", { 55 * 128.f, 24 * 128.f }, 240, 150);
	enemyObj2->AddComponent<Shark>();
	enemyObj2->GetScriptComponent<Shark>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	EnemyPrefab* enemyObj3 = new EnemyPrefab("Penguin", { 13 * 128.f, 20 * 128.f }, 150, 150);
	enemyObj3->AddComponent<Penguin>();
	enemyObj3->GetScriptComponent<Penguin>()->SetPlayerTransform(playerObj->GetComponent<Transform>());

	// 다음맵 포탈
	PortalPrefab* portalObj1 = new PortalPrefab("TransitionVerti", { 0.5 * 128.f, 4 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 5 * 128.f });
	PortalPrefab* portalObj2 = new PortalPrefab("TransitionVerti", { 0.5 * 128.f, 12 * 128.f }, 100.f, 400.f, { 1.5 * 128.f, 27 * 128.f });
